...
✅ Folder structure
✅ API endpoints
✅ Screenshots (placeholders for you to replace)
✅ Future improvements
...
3️⃣ Create .env
DATABASE_URL="postgresql://USER:PASSWORD@localhost:5432/subboard"
...
GET	/subscription/me	Get all user subscriptions
GET	/subscription/active	Get active subscription
DELETE	/subscription/unsubscribe/:id	Cancel subscription
GET	/subscription/all	Admin — list all
Plans
Method	Endpoint	Description
